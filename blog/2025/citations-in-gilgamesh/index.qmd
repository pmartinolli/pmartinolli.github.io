...
![[Tablette HS1360](https://commons.wikimedia.org/wiki/File:HS_1360_03_front.png) via Wikimedia Commons [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/deed.en)](HS_1360_03_front.png){fig-align="center" width="150"}
...
Ce n'est évidemment pas l'idéal car plusieurs oeuvres peuvent commencer de la même manière. Ces références sont facilement discernables avec la translitération du catalogue de Nibru (N2) datant de la période babylonienne ancienne^[Q](https://www.wikidata.org/wiki/Q138013643)^.

### Listes de sagesses

Certaines listes commencent à devenir sémantiquement plus complexes et leurs références aussi. Par exemple, les *Instructions de Shuruppak*^[Q](https://www.wikidata.org/wiki/Q3823132)^ sont une liste de sagesses, c'est-à-dire des conseils spirituels et moraux.
...
[^4]: Un processus semblable pourrait avoir eu lieu dans la Chine ancienne ([Zhang](https://doi.org/10.1515/978150150513)).

#### Enheduana l'exceptionnelle

Pour cette période, la prêtresse et princesse Enheduana^[Q](https://www.wikidata.org/wiki/Q232505)^ fait exception car plusieurs textes sumériens (par exemple le *Kesh Temple Hymn*^[Q](https://www.wikidata.org/wiki/Q5195547)^) lui sont attribués en tant que première et exclusive autrice de l'histoire^H&S^.

Je n'ai pas trouvé de documents anciens qui citent explicitement une des oeuvres de Enheduana. Par contre, pendant la première dynastie de Babylone (-1880 à -1595), le *Kesh Temple Hymn* est intégré au programme de formation des scribes dans un ensemble de dix textes nommés *The Decad^[Q](https://www.wikidata.org/wiki/Q5248677)^*. **On peut énoncé ainsi qu'une forme préliminaire de citation ou de mention à une oeuvre en tant que tel (et non à un document d'inventaire) ait été l'incorporation dans un canon officiel de textes.**

#### Citer pour soutenir, commenter, critiquer
