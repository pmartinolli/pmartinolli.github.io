...
### Citer pour participer au discours 

J'ai trouvé (pour le moment) que **les premières citations pour soutenir son propos, pour commenter ou critiquer des textes passés soient dans le domaine de la médecine**.

J'ai découvert que des chercheurs (comme Stol en 1992^WmG43^) ont remarqué des correspondances dans des tablettes du *Traité akkadien de diagnostics et pronostics médicaux*^Q^ , une compilation du XIe siècle de tablettes pouvant remonter au IIe millénaire. Ces correspondances renvoient à des tablettes plus anciennes à travers les mentions d'*incipits*. Cela placerait la médecine comme domaine le plus ancien qui utilise les références pour cette fonction. Malgré que le *Traité* soit emprunt de magie, il tente d'apporter de la rationalité au traitement médical et **les références pourraient soutenir cette intention rationnelle**.
