...
Par où commencer lorsqu’on veut explorer les pratiques de citation ? On m’a souvent dit que le plus ancien texte littéraire connu était *L’Épopée de Gilgamesh* ; pourquoi ne pas commencer par là ? Ne connaissant pas grand-chose au sujet, j’ai d’abord repéré un article particulièrement pédagogique de Szilvia Sövegjártó (marqué ^[Sz](https://doi.org/10.52093/hara-202201-0)^) pour explorer À partir de là, par citations et par boule de neige[^1].
