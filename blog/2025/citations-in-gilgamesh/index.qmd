...
Par où commencer quand on veut explorer les pratiques de citation ? On m'a toujours dit que le plus ancien texte littéraire était *L'épopée de Gilgamesh*, alors pourquoi commencer par là ? Pour rédiger ce billet, je me suis basé sur l'excellente mise en contexte présente dans l'article de Szilvia Sövegjártó (marqué ^[Sz](https://doi.org/10.52093/hara-202201-0)^). Nous allons découvrir non seulement les premières traces de références dans :

-   les sceaux, première marque et renvoi extra-textuel ;

-   la naissance de l'auteur, la première référence d'un texte ;

-   la notion de propriété, voire de protection, associée au marquage d'un document ;

-   la notion d'échange transactionnel, voire de reconnaissance de dette, dans le cadre d'un document signé ;

-   Les premières compilations de textes.

## Introduction

Si les berceaux de l'humanité se trouvent en Afrique, alors les premiers berceaux de la vie sociale en groupes denses se trouvent probablement dans la région appelée le « Croissant fertile », c'est-à-dire la Mésopotamie.

Cette région a vu naître de nombreuses inventions sociales et technologiques : urbanisation, commerce, irrigation, agriculture, etc. Parmi celles-ci nous allons nous pencher sur deux innovations de technologies cognitives qui vont révolutionner l'humanité : les sceaux et l'écriture. Les premières marques d'attribution vont apparaître dans le sillon de ces deux inventions.
...
D'abord sous la forme de tampons, puis aussi plus tard sous la forme de sceaux-cylindres^[Q](https://www.wikidata.org/wiki/Q1123756)^, ces outils permettent de sceller des denrées ou d'identifier la propriétés des biens en y apposant une « signature » avant de les entreposer dans un grenier commun. Ces objets sont souvent faits de pierres importées. Ils sont portés, voire arborés de manière ostentible pour signaler le statut de son porteur propriétaire et aussi comme amulette de protection^DC^.

Chaque sceau est constituée d'un ensemble de symboles qui sont sélectionnés et agencés pour représenter de manière abstraite une personne ou une institution. Ce sont ces symboles qui ont influencé les premiers caractères d'écriture^??^. **Ces caractéristiques vont se retrouver tout au long de l'histoire de la citation : une identité unique, nommée et matérialisée.**
...
Pendant la période Uruk (-3500 à -3100), certaines tablettes d'écritures reçoivent la marque de sceaux-cylindres. Je considère que ce sont les **premières références de l'histoire de l'écriture.** En effet, en combinant ces deux technologies, nous avons désormais une information riche encodée sur une tablette d'argile, associée avec une autre information qui fait une référence à une entité nommée en dehors du document.

Outre le marquage de la propriété, les sceaux sur les documents servent aussi de signatures sur les contrats, les traités ou les lettres (très rare dans Early Dynastic et Akkadian times, plus courant en Ur III times).
...
De manière intéressante, il semble que ces sceaux soient aussi considérés comme des amulettes de protection magiques. En effet, c'est comme s'ils étendent le pouvoir de la protection de la propriété à la protection de la personne (contre les fausses couches, la magie noire, le démon de la maladie, etc.). ^DC118^
...
Tous les auteurs originaux de chacun des proverbes sont perdus, ainsi que les scribes compilateurs. Ce n'est que vers -2000 que les scribes mentionnent parfois leurs noms dans le colophon[^1] des textes. Cependant, c'est probablement plus une mention de propriété que d'autorialité car ils ne précisent pas leurs rôles de copistes ou d'éditeurs ^VdM^.

[^1]: Colophon : les notes du scribe vers la fin du texte.

Les *Instructions de Shuruppak* aspirent à une dimension historique car nous avons le nom de l'auteur celui de son père et celui de son fils. De plus, cette figure de style se rapproche de ce que l'on trouve dans les listes des rois. Par la suite, d'autres listes d'instructions se sont développées. **Selon les intentions éditoriales des scribes, elles étaient attribuées à des fermiers, à des dirigeants, à des figures légendaires, etc.** Par exemple, lorsqu'elles étaient attribuées à un fermier (par exemple *Farmer's Instructions*^[Q](https://www.wikidata.org/wiki/Q137438077)^), c'était dans le but d'exprimer une sagesse populaire commune. Tandis que si elles étaient attribuées à un dieu alors les proverbes avaient un rôle normatif dans la société (par exemple *Instructions of Ur-Ninurta*).^Sz^
...
Même dans la société babylonienne ancienne, l'autorialité n'était pas un enjeu. Probablement parce que les textes étaient recopiés ou remémorés par des copistes qui faisaient parfois des modifications par rapport à l'original et donc participaient et se fondaient dans la chaîne de production du savoir. Dans ce contexte « La quête d'auteurs uniques et originaux ne faisaient pas trop de sens \[ma trad.\]» ^BL^. Pour cette période, la prêtresse et princesse Enheduana^[Q](https://www.wikidata.org/wiki/Q232505)^ fait exception car plusieurs textes sumériens (ex: *Kesh Temple Hymn*^[Q](https://www.wikidata.org/wiki/Q5195547)^) lui sont attribués en tant que première et exclusive autrice de l'histoire^H&S^.

Je n'ai pas trouvé de documents anciens qui citent explicitement une des oeuvres de Enheduana. Par contre, pendant la première dynastie de Babylone (-1880 à -1595), le *Kesh Temple Hymn* sera intégré au programme de formation des scribes dans un ensemble de dix textes nommés *The Decad^[Q](https://www.wikidata.org/wiki/Q5248677)^*. **On peut énoncé ainsi qu'une forme préliminaire de citation ou de mention ait été l'incorporation dans un canon officiel de textes.**
...
Pour retracer les sources, vous pouvez consulter les propriétés de l'éléments Wikidata, marqué ^Q^, ou dérouler le menu *References* des valeurs à vérifier. Ou bien, vous pouvez descendre au bas de la page de l'élément et visiter les pages Wikipédia dans différents espaces linguistiques (fr, en, etc.).
...
-   Epic of Gilgamesh (Q8272); Decad (Q5248677);
    ...
    -   A balbale to Inana (Q137506645); Sumerian temple hymns (Q137506392); Hymn to Inana (Q137454369); The Exaltation of Inanna (Q105794259)
