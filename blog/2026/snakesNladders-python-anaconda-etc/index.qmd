...
Depuis Windows, installer [Ghostscript](https://ghostscript.com/releases/gsdnld.html).

Depuis Windows, installer [Tesseract](https://github.com/UB-Mannheim/tesseract/wiki). Cocher les 4 cases sur la première fenêtre. Ajouter toutes les langues que vous voulez dans la personnalisation de l'installation.
