...
On pourrait modifier le code pour générer un index avec tous les mots-clés cherchés en contexte (*Keyword in Context* ou *KWIC*) et ainsi comprendre comment ils sont utilisés dans le texte.
...
Ensuite, **Edmond** **Halley** (32x) qui finança cette oeuvre et les travaux de Newton. D'ailleurs, le livre commence par un épigraphe de Halley.
