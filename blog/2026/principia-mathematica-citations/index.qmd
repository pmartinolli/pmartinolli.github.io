...
Avec Notepad++, utiliser quelques noms pour les compter manuellement quelques entités nommées dans le corpus (Fonction Rechercher + Compter) et vérifier que le code fonctionne.
...
Cette analyse avec peu de connaissances préalables des *Principia* a besoin d'être contextualisée par la lecture de la conversation scientifique historique sur le sujet (l'historiographie).
