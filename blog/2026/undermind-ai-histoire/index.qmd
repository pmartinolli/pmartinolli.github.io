...
Selon [cet article](https://doi.org/10.1515/bfp-2023-0057), Semantic Scholar ne contiendrait que 34 386 études en histoire (dont 33,24% en libre accès), soit 0.13% du corpus total. **Cependant**, cet article se base sur des données de 2008 à 2020 et les maisons d'édition contenant des études historiques ont été rajoutées par la suite.
...
### Biais généraux envers l'histoire
...
- **Agent recherche :** raffiner les questions et pour classer les résultats. Selon moi, c'est [l'aspect le plus performant]{.underline} de Undermind.
...
- Les explorations et recommandations ont été faites par moi, par des lectures des tests de [Aaron Tay](https://aarontay.substack.com/) et du [papier](https://www.undermind.ai/whitepaper.pdf) (biaisé) de Undermind sur le sujet.
