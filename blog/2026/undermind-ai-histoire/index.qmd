...
description: "Où l'on explore l'outil de découverte Undermind pour la recherche d'études en histoire. Il utilise de l'IA générative, principalement à travers des agents de recherche et de traitement. On en profite pour affûter une démarche critique vis-à-vis de ces nouvelles méthodes de repérage et de traitement de la documentation."
---

## Introduction

Undermind.ai est un outil de découverte de littérature scientifique utilisant l'IA générative. En 2026, les Bibliothèques de l'Université de Montréal se sont abonnées pour un an à trois outils de ce type dont Undermind. En voici quelques tests pour le domaine de l'histoire.

## Corpus

Undermind.ai utilise principalement [Semantic Scholar](https://www.semanticscholar.org/), soit plus de [200](https://www.semanticscholar.org/product) millions d'études (articles de revues principalement). Cet index est géré par *The Allen Institute for Artificial Intelligence ([Ai2](https://allenai.org/))* qui fait des efforts pour diffuser en code source ouvert la plupart de ses projets.

Il a été conçu à l'origine pour l'informatique, la biomédecine, les neuroscience, etc. Depuis 2024-2025 environ, il a intégré des éditeurs en sciences humaines et sociales. Semantic Scholar contient les notices de ces [maisons d'édition](https://www.semanticscholar.org/about/publishers) ou bases de données bibliographiques :
...
- Microsoft Academic Graph (concurrent de Google Scholar qui a disparu)
...
- etc. Il y en a d'autres. Je n'ai listé ci-dessus que les ressources qui contiennent de la documentation en histoire.

Selon [cet article](https://doi.org/10.1515/bfp-2023-0057), le domaine de l'histoire ne contiendrait que 34 386 études (dont 33,24% en libre accès), soit 0.13% du corpus total. **Cependant**, cet article se base sur des données de 2008 à 2020 et les maisons d'édition contenant des études historiques ont été rajoutées par la suite. Si on fait une recherche simple avec le mot-clé *history* et que l'on filtre par Domaine d'étude : Histoire on obtient **1,4 millions de résultats** (juillet 2026). En volume, c'est l'équivalent des deux bases de données disciplinaires *Historical Abstracts* et *America History & Life* combinées.

## Fonctionnement

Ces explorations ont été faites par moi, par des lectures des tests de [Aaron Tay](https://aarontay.substack.com/) et du [papier](https://www.undermind.ai/whitepaper.pdf) (biaisé) de Undermind sur le sujet.

Les algorithmes de Undermind utilisent GPT 4 qui pilote des agents pour 3 phases :

- **Agent recherche :** raffiner les questions et pour classer les résultats, pour suivre certains liens de citation, pour étendre la recherche booléenne de termes spécifiques à une recherche sémantique basée sur le poid des expressions. Selon moi, c'est [l'aspect le plus performant]{.underline} de Undermind.
...
- Undermind utilise seulement le titre et le résumé. Une fois les résultats affichés, il est possible de lancer un agent dans le texte intégral quand celui-ci est disponible.
...
- Lancer plusieurs recherches dans un même projet avec différents angles pour augmenter l’ensemble des *All papers*.
  ...
  - Avancé : Comme il n'y a pas de possibilité de supprimer des documents de All papers (et de virer les faux positifs) : Mettre sa sélection de documents dans *Starred* puis lancer un agent sur cette sur cette vue.

### Agent traitement : suggestions de demandes 

Une fois la recherche terminée, voici quelques suggestions à lancer avec l'agent conversationnel de Undermind.
...
3.  Demander à l'agent conversationnel : « Extrait tous les concepts et toutes les méthodes importantes à maîtriser pour étudier ce sujet à partir des documents. »
...
- Même si Undermind n'a pas été conçu pour cela, il est possible de demander de faire des actions non-prévues hors du strict cadre recherche-traitement-rédaction :
...
Bref, toutes les fonctionnalités qui permettent de pousser vers les sources et de mieux les traiter sont « bonnes ».

## Désavantages

Par leur nature conversationnelle, ces types d'outils peuvent garder l'engagement de l'utilisateur à l'intérieur de l'outil sans les pousser vers les sources (ce n'est pas unique à Undermind). Exemples :
...
Bref, toutes les fonctionnalités qui font « travailler hors-sol » sans aller vers les sources sont « mauvaises ».
...
- Former aux biais lors des processus de recherche avec ces types d'outils.
...
- Par nature, les algorithmes génératifs applatissent les nuances, les aspérités, les achoppements, etc. Or faire de l'histoire, n'est-ce pas de les repérer, de les comparer, de les contextualiser, de les analyser et de les restituer dans un argumentaire ?
  ...
  - Évolution rapide : l'an passé mon exemple favori pour montrer les erreurs de l'IAgen était de demander régulièrement aux outils IA avec des fonctions génératives : « Est-ce que Harry Truman est le décideur final du bombardement de Hiroshima et de Nagazaki ? » Jusqu'à mai 2026, les réponses ont toujours été décevantes. Depuis peu, elles sont plus nuancées et proches du « [consensus](#0) » historique sur la question.

- Les outils IA peuvent être des outils bloqués sur la [lecture distante](#0). Il faut les forcer à faire de la « [lecture télescopique](#0) » pour se rapprocher des sources.
