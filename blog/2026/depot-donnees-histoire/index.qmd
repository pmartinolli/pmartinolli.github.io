...
Même si elle existe depuis longtemps dans certains domaines (aéronautique, nucléaire,...), c'est une mode récente de la publication scientifique. Elle est rendue possible par les infrastructures technologiques d'hébergement de grands volumes d'information et par les techniques d'archivage digitales.

Les organismes de financement demandent de plus en plus d'aller dans cette direction. Pour le moment, ils insistent surtout sur comment les données sont gérées (et pas forcément diffusées) avec un **plan de gestion des données de recherche** détaillé et explicite.
...
-   Un chapitre de mon *Manuel de recherche documentaire* a une [section d'exemples pour l'histoire](https://pmartinolli.github.io/QMpRD/chapters/gestiondonneesrecherche.htm).
