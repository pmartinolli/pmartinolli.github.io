...
Il est aussi possible de publier des data papers qui accompagnent un versement de données de recherche. C'est ce que fait la revue [*Data & Corpus*](https://dc.episciences.org/) (exemple avec [*The Jean Nicolas Database. The French Rebellion, 1661-1789*](https://dc.episciences.org/articles/15892)).

Enfin, une autre possibilité consiste à publier les données de recherche en même temps que la publication scientifique. Cela demande une plateforme avancée. C'est le pari ambitieux qu'a fait la revue [*Journal of Digital History*](https://journalofdigitalhistory.org/) puisqu'on y trouve des articles révisés par les pairs, avec les données de recherche, les visualisations et le code source (exemple avec [*Gaming the Qing Mandarinate: Digital Approaches to a Nineteenth-Century Chinese Board Game*](https://journalofdigitalhistory.org/en/article/boXXEPfnFTRe)).
