...
En cas de non accès au JCR (car il est *paywalled*), je suggère de visiter le site web des revues. En effet, si une revue possède un JIF, alors il y a de grandes chances qu'elle affiche un JCR récent sur son site.
